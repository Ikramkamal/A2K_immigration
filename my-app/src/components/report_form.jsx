...
//             <select name="immigrationCategory" value={formData.immigrationCategory} onChange={handleChange} required>
...
//           <label>Surname: <input name="surname" value={formData.surname} onChange={handleChange} required /></label>
...
//           <label>Birth Date: <input type="date" name="birthDate" value={formData.birthDate} onChange={handleChange} required /></label>
...
//           <label>Children Information: <textarea name="childrenInfo" value={formData.childrenInfo} onChange={handleChange} /></label>
//           <label>Language Test: <textarea name="languageTest" value={formData.languageTest} onChange={handleChange} /></label>

//           <button type="submit">Proceed to Payment</button>
//         </form>
//       ) : (
//         // ✅ only clientSecret needed now
